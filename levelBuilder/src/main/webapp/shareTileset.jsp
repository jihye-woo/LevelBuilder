...
<div class="container">
    ...
    <h2 class="form-signin-heading" align="center">Share Tileset Using Email or Username</h2>
    <form:form method="POST" modelAttribute="userToShareWith" class="form-signin">
        ...
        <div>
            <h3 align="center"> <a href="/my-tilesets">Back to Tilesets</a> </h3>
        </div>
    </form:form>
